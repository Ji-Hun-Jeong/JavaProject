...
public class Working_Scene extends Scene
{
    ...
    public Working_Scene()
    {
        ...
        //m_arrPanel[PANEL_TYPE.BUTTON.ordinal()].addMouseListener(singleMouseListener);
        //m_arrPanel[PANEL_TYPE.BUTTON.ordinal()].addMouseMotionListener(singleMouseListener);

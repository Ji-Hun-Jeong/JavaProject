...
public class ButPanel extends MyPanel
{
    ...
    public ButPanel()
    {
        ...
        m_arrButton[BUTTON_TYPE.SAVEFILE.ordinal()] = new JButton(BUTTON_TYPE.SAVEFILE.name());
        m_arrButton[BUTTON_TYPE.CLEARFILE.ordinal()] = new JButton(BUTTON_TYPE.CLEARFILE.name());
        ...
        m_arrButton[BUTTON_TYPE.CLEAR.ordinal()].setBackground(Color.RED);
        m_arrButton[BUTTON_TYPE.CHANGE.ordinal()].setBackground(Color.CYAN);
        m_arrButton[BUTTON_TYPE.SAVEFILE.ordinal()].setBackground(Color.YELLOW);
        m_arrButton[BUTTON_TYPE.CLEARFILE.ordinal()].setBackground(Color.YELLOW);
